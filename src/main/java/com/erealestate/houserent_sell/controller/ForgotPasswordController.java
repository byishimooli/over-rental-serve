...
import com.erealestate.houserent_sell.service.EmailService;
...
@RestController
@RequestMapping("/auth")
@CrossOrigin(origins = { "http://localhost:5173", "http://127.0.0.1:3000", "http://localhost:3000",
...
public class ForgotPasswordController {
    ...
    public ResponseEntity<String> processForgotPassword(@RequestBody Map<String, String> request) {
        ...
        String body = "Hello from Over Rental!\n\nWe received a request to reset your password for your Over Rentals account. To reset it, simply click the link below:\n"
                + resetLink
                + "\n\nIf you didn't request a password reset, please ignore this message.\n\nThank you for renting with us!\n\nBest regards,\nThe Over Rentals Team";
